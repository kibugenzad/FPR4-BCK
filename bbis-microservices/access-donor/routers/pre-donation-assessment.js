...
const apiUrl = "/access";
const routeUrl = `${apiUrl}/preDonationAssessment`;
const serviceName = "PreDonationAssessment";
...
// delete data
router.delete(routeUrl, (req, res, next) =>
  handleRequest("delete", req, res, next, serviceName, Controller)
);
