...
const microserviceBaseUrl = process.env.ACCESS_MICROSERVICE_URL || `${config.accessMicroserviceUrl}/api/access/serviceCatergory`;
const gatewayAPIUrl = "/access/serviceCatergory";
